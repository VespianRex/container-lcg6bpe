...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lcg6bpe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lcg6bpe.containers.anotherwebservice.com/
...
```
git clone git@github.com:VespianRex/container-lcg6bpe.git
cd container-lcg6bpe
```
...
```
docker attach container-lcg6bpe
```
